...
void SpiWrite (int spi_device, unsigned char& data) {
    SpiWriteAndRead(spi_device, &data, 1);
}
unsigned char SpiWriteAndRead(int spi_device, unsigned char data) {
    unsigned char read = data;
    SpiWriteAndRead(spi_device, &read, 1);
    return read;
}
